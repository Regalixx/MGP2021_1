...
public class HealthPowerupEntity implements  EntityBase,Collidable{
   public final static HealthPowerupEntity Instance = new HealthPowerupEntity();
    ...
    public void Init(SurfaceView _view){
        bmp = BitmapFactory.decodeResource(_view.getResources(), R.drawable.healthpowerup);
    ...
    public int GetRenderLayer() {
        ...
        return LayerConstants.HEALTHPOWERUP_LAYER;
    }
    ...
    public ENTITY_TYPE GetEntityType() {
        return ENTITY_TYPE.ENT_HEALTHPOWERUP;
    }

    public static HealthPowerupEntity Create() {
        HealthPowerupEntity result = new HealthPowerupEntity();
        EntityManager.Instance.AddEntity(result,ENTITY_TYPE.ENT_HEALTHPOWERUP);
        return result;
    }
