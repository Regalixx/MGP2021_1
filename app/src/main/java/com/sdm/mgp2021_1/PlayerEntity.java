...
public class PlayerEntity implements EntityBase, Collidable {
    ...
    public void Init(SurfaceView _view){
        ...
        xPos = _view.getWidth()* 0.1f; //setting the x position to spawn
        yStart = yPos = _view.getHeight() * 0.5f; //setting the y position to spawn
    ...
    public void Render(Canvas _canvas) {
        ...
        transform.postTranslate(-bmp.getWidth() * 0.5f, -bmp.getHeight() * 0.5f); // make it not look so scuffed.
